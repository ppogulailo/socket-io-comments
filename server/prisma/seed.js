...
async function seed() {
  ...
  const kyle = await prisma.user.create({ data: { name: "Kyle" ,email:'ergergersgerhgergerfgver',password:'fsdfsdfsdfsdf'} })
  const sally = await prisma.user.create({ data: { name: "Sally" ,email:'ergergeskrgergergerfgver',password:'fsdfsdfsdfsdf'} })
